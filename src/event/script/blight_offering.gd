...
func get_options():
	...
	OptionPreview.instantiate().nodes_preview("Take 20 Damage. Pick one of these three 'Blight' cards to add to your deck", cards), func():
...
func check_prerequisites():
	return turn_manager.blight_damage >= 1 and turn_manager.blight_damage < Global.MAX_HEALTH - 20
